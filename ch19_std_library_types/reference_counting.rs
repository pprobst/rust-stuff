 ...
 * means there are no owners remained, both the Rc and the value are all dropped.
 *
 * Cloning an Rc never do a deep copy. Cloning creates just another pointer to the wrapped value, 
