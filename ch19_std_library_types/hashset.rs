/*
 * Consider a HashSet as a HashMap where we just care about the keys (HashSet<T> is, in actuality,
 * just a wrapper around HashMap<T, ()>).
 *
 * "What's the point of that?" you ask. "I could just store the keys in a Vec."
 *
 * A HashSet's unique feature is that it is guaranteed to not have duplicate elements. That's the 
 ...
 *
 * This is great for when you never want more than one of something, or when you want to know if 
