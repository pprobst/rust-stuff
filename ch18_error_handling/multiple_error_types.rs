/*
 * Sometimes an Option needs to interact with a Result, or a Result<T, Error1> needs to interact
 * with a Result<T, Error2>. In those cases, we want to manage our different error types in a way
