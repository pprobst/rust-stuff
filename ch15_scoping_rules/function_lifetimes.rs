...
// Multiple elements with different lifetimes. In this case, it would be fine for both to
// have the same lifetime ''a', but in more complex cases, different lifetimes may be required.
...
// Then the data is dropped upon exiting the scope, leaving a reference to invalid data to 
// be returned.
