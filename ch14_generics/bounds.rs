/*
 * When working with generics, the type parameters often use traits as bounds to stipulate what
 * functionality a type implements. For example, the following example uses the trait Display to
...
// As an additional note, where clauses can also be used to apply bounds in some cases to 
// be more expressive.
