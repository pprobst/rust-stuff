/*
 * Closures succinctly capture variables from enclosing scopes. Does this have any c
 * onsequences? It surely does. Observe how using a closure as a function parameter 
 ...
 * to store the captured variables inside, meanwhile implementing the functionality via 
 * one of the traits: Fn, FnMut, or FnOnce for this unknown type. This type is assigned 
