 ...
 * to this is to use the parse function and either to arrange for type inference or to specify
 * the type to parse using the 'turbofish' syntax. Both alternatives are shown in the following
 * example.
 *
 ...
 * library. To obtain this functionality on a user defined type simply implement the 
