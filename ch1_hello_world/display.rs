...
// Define a structure for which 'fmt::Display' will be implemented. This is a tuple struct
// named 'Structure' that contains an 'i32'.
struct Structure(i32);

// To use the '{}' marker, the trait 'fmt::Display' must be implemented manually for the type.
impl fmt::Display for Structure {
    // This trait requres 'fmt' with this exact signature.
